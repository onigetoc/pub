...
export declare class MetadataExtractor {
    ...
    private static isPlaceholderValue;
    private static firstValid;
    private static getAuthor;
    private static extractByline;
    private static cleanAuthorString;
    private static getSiteName;
    private static getBestTitle;
    private static isSiteIdentifier;
    ...
    private static isLinkedToOtherPage;
    private static readonly MONTH_MAP;
    static parseDateText(text: string): string;
    private static getVisibleText;
    private static getAuthorName;
